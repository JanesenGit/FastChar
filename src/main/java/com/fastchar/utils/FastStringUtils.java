...
public class FastStringUtils {
     ...
     * 转义正则特殊字符
     */
    public static String escapeRegexChar(String content) {
        if (FastStringUtils.isNotEmpty(content)) {
            String[] regexJustChar = {"\\", "$", "(", ")", "*", "+", ".", "[", "]", "?", "^", "{", "}", "|"};
            for (String key : regexJustChar) {
    ...
    private static String[] splitByCharacterType(final String str, final boolean camelCase) {
        ...
        if (str.isEmpty()) {
            return FastArrayUtils.EMPTY_STRING_ARRAY;
        }
        ...
        return list.toArray(FastArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    private static String[] splitByWholeSeparatorWorker(
        ...
        return substrings.toArray(FastArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    private static String replaceEach(
        ...
        if (isEmpty(text) || FastArrayUtils.isEmpty(searchList) || FastArrayUtils.isEmpty(replacementList) || (FastArrayUtils.isNotEmpty(searchList) && timeToLive == -1)) {
            return text;
        }
